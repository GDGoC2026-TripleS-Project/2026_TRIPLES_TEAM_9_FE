    ...
    const load = async () => {
      ...
      try {
        const [meRes, infoRes, summaryRes, monthlyRes] = await Promise.allSettled(
          [getMyProfile(), getUserInfo(), getDashboardSummary(), getDashboardMonthly()]
        );
              ...
              <div className="my-form-header">
                ...
                <div className="my-actions">
                  {!isEditing ? (
                    ...
                    <>
                      <button className="my-btn ghost" type="button" onClick={onCancel}>
                        취소
                      </button>
                      <button
                        className="my-btn"
                      ...
                      return (
                        <button
                          ...
                          onClick={() => {
                            ...
                            setFieldValue("learningGoal", selected ? "" : value);
                          }}
                          disabled={disabled}
                        >
                          {label}
                ...
                <div className="my-field">
                  ...
                  <div className="my-chip-grid">
                    {fieldOptions.map(([value, label]) => {
                      ...
                      const disabled = (!selected && maxFieldSelected) || !isEditing;
                      return (
                        <button
                          key={value}
                          type="button"
